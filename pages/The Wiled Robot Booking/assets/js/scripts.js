document.addEventListener("DOMContentLoaded", () => {
    ...
    function getReservationKey() {
        const movie = "theWildRobot";
        return `${movie}-${locationSelect.value}-${dateSelect.value}-${timeSelect.value}`;
    }

    function loadReservedSeats() {
        const reservationKey = getReservationKey();
        const reservations = JSON.parse(localStorage.getItem("theWildRobot")) || {};  // Use "theWildRobot" for storing and retrieving
    ...
    submitButton.addEventListener("click", () => {
        ...
        const reservationKey = getReservationKey();
        let reservations = JSON.parse(localStorage.getItem("theWildRobot")) || {};  // Use "theWildRobot" for storing and retrieving
        ...
        localStorage.setItem("theWildRobot", JSON.stringify(reservations));  // Use "theWildRobot" for storing reservations
    ...
    function resetSeatsAtMidnight() {
        ...
        setTimeout(() => {
            localStorage.removeItem("theWildRobot");  // Clear "theWildRobot" data at midnight
            loadReservedSeats();
        }, timeUntilMidnight);
    }
