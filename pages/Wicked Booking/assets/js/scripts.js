document.addEventListener("DOMContentLoaded", () => {
    ...
    function getReservationKey() {
        const movie = "wicked";  // Add the movie name
    ...
    function loadReservedSeats() {
        ...
        const reservations = JSON.parse(localStorage.getItem("wicked")) || {};  // Retrieve reservations using "wicked"
    ...
    submitButton.addEventListener("click", () => {
        ...
        const reservationKey = getReservationKey();
        let reservations = JSON.parse(localStorage.getItem("wicked")) || {};  // Retrieve reservations using "wicked"
        ...
        localStorage.setItem("wicked", JSON.stringify(reservations));  // Store reservations under "wicked"
    ...
    function resetSeatsAtMidnight() {
        ...
        setTimeout(() => {
            localStorage.removeItem("wicked");
            loadReservedSeats();
        }, timeUntilMidnight);
    }
